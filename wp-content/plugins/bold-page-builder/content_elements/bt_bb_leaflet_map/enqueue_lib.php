...
function bt_bb_include_scripts_leaflet() {
	...
	/* css */
    wp_enqueue_style( 'bt_bb_framework-leaflet-css', plugin_dir_url( __FILE__ ) . 'leafletmap/lib/leaflet.css', array(), BT_BB_VERSION, 'screen' );
    ...
    wp_enqueue_style( 'bt_bb_framework-markercluster-default-css',  plugin_dir_url( __FILE__ ) . 'leafletmap/lib/MarkerCluster.Default.css', array(), BT_BB_VERSION, 'screen' ); 
